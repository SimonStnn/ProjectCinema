...
export default function AddScreening() {
  ...
  const onSubmit = async (values: z.infer<typeof formSchema>) => {
    ...
    try {
      ...
      // Calculate end time (assume 2 hours for simplicity)
      const endTime = new Date(values.start_time);
      ...
      setError(
        err instanceof Error
          ? err.message
          : "Failed to create screening. Please try again."
      );
      setLoading(false);
    }
  };
  ...
  return (
    <div className="container mx-auto py-6">
      <div className="max-w-md mx-auto">
        <Card>
          <CardHeader>
            <CardTitle>Add New Screening</CardTitle>
            <CardDescription>
              Create a new movie screening with time and pricing
            </CardDescription>
          </CardHeader>
          <CardContent>
            <Form {...form}>
              ...
              >
                      ...
                      <Popover>
                        ...
                        <PopoverContent className="w-auto p-0" align="start">
                          <Calendar
                            ...
                            onSelect={(date) => {
                              if (date) {
                                // When calendar date is selected, update with current time
                                const now = new Date();
                ...
                {success && (
                  <div className="text-green-500 text-sm">
                    Screening created successfully! Redirecting...
                  </div>
                )}
